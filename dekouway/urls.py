...
from apps.dashboard.views.client import ClientProfileView, ClientReservationsView
...
urlpatterns = [
    ...
    path('mes-reservations/', ClientReservationsView.as_view(), name='bookings_list'),

    path('', include('apps.core.urls', namespace='public')),
    path('auth/', include('apps.accounts.urls', namespace='accounts')),
    path('annonces/', include('apps.properties.urls', namespace='properties')),
